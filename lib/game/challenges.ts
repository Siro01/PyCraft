...
export const CHALLENGES: Challenge[] = [
  ...
  // ── JUNIOR ──
  {
    ...
    title: 'Las variables de Steve',
    description: 'Completá los valores: `nombre = "Steve"` y `vida = 20`. El código ya imprime las dos variables.',
    type: 'python',
    tier: 'junior',
    expectedOutput: 'Steve\n20',
    initialCode: 'nombre = ___\nvida = ___\n\nprint(nombre)\nprint(vida)',
    damage: 50,
    orderIndex: 0,
    tip: 'Las variables guardan datos. El texto siempre va entre comillas `""` (llamamos a eso un string). Los números enteros van sin comillas.',
  },
  {
    id: 'c01-j2',
    bossId: 'creeper-formulario',
    title: 'El nivel del héroe',
    description: 'Completá el f-string para mostrar el nombre y nivel del jugador. `jugador = "Alex"`, `nivel = 3`. Debe imprimir: `Jugador: Alex - Nivel 3`.',
    type: 'python',
    tier: 'junior',
    expectedOutput: 'Jugador: Alex - Nivel 3',
    initialCode: 'jugador = "Alex"\nnivel = 3\n\nprint(f"Jugador: {___} - Nivel {___}")',
    damage: 50,
    orderIndex: 1,
    tip: 'En un f-string escribís `{nombre_variable}` y Python reemplaza eso con el valor de la variable. ¿Cómo se llaman las dos variables definidas arriba?',
  },
  {
    id: 'c01-j3',
    bossId: 'creeper-formulario',
    title: 'Bloques recolectados',
    description: 'Calculá `bloques_total` sumando `bloques_madera` y `bloques_piedra`. Imprimí solo el número.',
    type: 'python',
    tier: 'junior',
    expectedOutput: '15',
    initialCode: 'bloques_madera = 8\nbloques_piedra = 7\n\nbloques_total = ___ + ___\nprint(bloques_total)',
    damage: 50,
    orderIndex: 2,
    tip: 'Para sumar dos cosas usás el operador `+`. Los dos huecos son los nombres de las variables que ya están definidas arriba.',
  },
  ...
  },
  {
    ...
    description: 'Calculá el `peso_total` de tres ítems usando las variables dadas. Imprimí solo el número resultante.',
    type: 'python',
    tier: 'trainee',
    expectedOutput: '16.5',
  ...
  },
  {
    id: 'c03-j2',
    bossId: 'golem-infinito',
    title: 'Recolectar madera',
    description: 'Completá el `while` para que imprima `"Bloque recolectado"` exactamente 4 veces.',
    type: 'python',
    tier: 'junior',
    expectedOutput: 'Bloque recolectado\nBloque recolectado\nBloque recolectado\nBloque recolectado',
    initialCode: 'contador = 0\n\nwhile contador < ___:\n    print("Bloque recolectado")\n    contador = contador + 1',
    damage: 65,
    orderIndex: 1,
    tip: 'El `while` repite mientras la condición sea verdadera. Empieza en 0 y cada vuelta suma 1. Para que se repita exactamente 4 veces, ¿cuándo tiene que parar?',
  },
  {
    id: 'c03-j3',
    bossId: 'golem-infinito',
    title: 'Suma de bloques',
    description: 'Completá el `range()` para sumar los números del 1 al 5. El resultado debe ser `15`.',
    type: 'python',
    tier: 'junior',
    expectedOutput: '15',
    ...
    damage: 70,
    orderIndex: 2,
    tip: '`range(1, n)` genera números del 1 hasta `n-1`. Para incluir el 5 en la suma, el número del hueco tiene que ser 5 + 1.',
  },
  ...
  },
  {
    id: 'c04-j2',
    bossId: 'mercader-abismo',
    title: 'La ficha del monstruo',
    description: 'Accedé a las claves `"nombre"` y `"vida"` del diccionario e imprimí cada una.',
    type: 'python',
    tier: 'junior',
    expectedOutput: 'Dragón\n50',
    initialCode: 'monstruo = {"nombre": "Dragón", "vida": 50, "tipo": "jefe"}\n\nprint(monstruo[___])\nprint(monstruo[___])',
    damage: 75,
    orderIndex: 1,
    tip: 'Un diccionario guarda datos con "clave: valor". Para acceder usás `diccionario["clave"]`. Las claves disponibles son `"nombre"`, `"vida"` y `"tipo"`.',
  },
  {
    id: 'c04-j3',
    bossId: 'mercader-abismo',
  ...
  },
  {
    id: 'c05-j2',
    bossId: 'maestro-craftero',
    title: 'Función de daño',
    description: 'Completá el `return` para que `calcular_dano(10)` retorne `20` (ataque multiplicado por 2).',
    type: 'python',
    tier: 'junior',
    expectedOutput: '20',
    initialCode: 'def calcular_dano(ataque):\n    return ataque * ___\n\nprint(calcular_dano(10))',
    damage: 80,
    orderIndex: 1,
    tip: 'Si `calcular_dano(10)` tiene que dar `20`, por cuánto multiplicamos 10? `10 × ___ = 20`.',
  },
  {
    id: 'c05-j3',
    bossId: 'maestro-craftero',
...
INSERT INTO monstruos VALUES (4,'Zombie B','Zombie',30);`,
  ...
  },
  {
    ...
    description: 'Completá el `GROUP BY` para contar cuántos monstruos hay de cada tipo. Ordenado por tipo.',
    type: 'sql',
    tier: 'junior',
    seedSQL: `CREATE TABLE monstruos (id INTEGER PRIMARY KEY, nombre TEXT, tipo TEXT, hp INTEGER);
INSERT INTO monstruos VALUES (1,'Creeper A','Creeper',30);
...
INSERT INTO monstruos VALUES (4,'Zombie B','Zombie',30);`,
    ...
    damage: 105,
    orderIndex: 2,
    tip: '`GROUP BY columna` agrupa las filas que tienen el mismo valor en esa columna. Acá queremos agrupar por la columna `tipo`.',
  },
...
INSERT INTO monstruos VALUES (5,'Esqueleto B','Esqueleto',60);`,
  ...
  },
  {
    ...
    description: 'Agrupá por `tipo` y contá cuántos monstruos hay de cada tipo. Ordená por `tipo` alfabéticamente.',
    type: 'sql',
    tier: 'trainee',
    seedSQL: `CREATE TABLE monstruos (id INTEGER PRIMARY KEY, nombre TEXT, tipo TEXT, hp INTEGER);
INSERT INTO monstruos VALUES (1,'Creeper A','Creeper',30);
