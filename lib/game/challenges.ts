...
export const CHALLENGES: Challenge[] = [
  ...
  // ── JUNIOR ──
  {
    ...
    description: 'Completá las variables de la tarjeta: `nombre_item = "Espada de diamante"`, `cantidad = 3`, `material = "diamante"`. El código ya imprime las tres.',
    type: 'python',
    tier: 'junior',
    expectedOutput: 'Espada de diamante\n3\ndiamante',
    initialCode: 'nombre_item = ___\ncantidad = ___\nmaterial = ___\n\nprint(nombre_item)\nprint(cantidad)\nprint(material)',
    damage: 50,
    orderIndex: 0,
    tip: 'Una variable es una etiqueta con un valor adentro. El texto va entre comillas `"..."`, los números van sin comillas. Completá los tres valores de la tarjeta.',
  },
  {
    id: 'c01-j2',
    bossId: 'creeper-formulario',
  ...
  },
  {
    ...
    description: 'Completá `peso_total` multiplicando y sumando los ítems del cofre. Debe imprimir `16.5`.',
    type: 'python',
    tier: 'junior',
    expectedOutput: '16.5',
